defmodule Whosthebest.Authorize do

  import Plug.Conn
  import Phoenix.Controller
  #alias Whosthebest.{Repo, User}
  ...
  the user from the database, uncomment the line `alias Whosthebest.{Repo, User}`
  ...
  Add the following line to the controller which handles login:
      ...
      plug Openmaize.Login, [db_module: Whosthebest.OpenmaizeEcto] when action in [:login_user]
